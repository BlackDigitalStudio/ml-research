...
**ЗАДЕПЛОЕНО 2026-07-26 00:24:57 UTC (OPS-EXEC rev2):** DOGE — единственный
live-инстанс, весь депозит 20.43 USDC, exec v3 M=8, SIZE_FRAC=1.0,
NOTIONAL_MULT=2.2, lev 3 (per-trade ~5.6 USDC, пик ~45 нотионала);
