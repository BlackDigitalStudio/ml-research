...
# OPT-IN (OBJSEL rev2, default OFF -> the search path is untouched): same contract as the
# v1 trainer. Supply the per-fold hyperparameters instead of searching for them, so an arm
# can be refit to deployed semantics under a CHOSEN trial.
